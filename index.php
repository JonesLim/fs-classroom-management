<?php
    ...
    //$_GET
    //$_POST
    //$_REQUEST (combination of GET & POST // USUALLY NOT USE MUCH)
    // $_SERVER (to get a bunch of info)// -SERVER_NAME
                                        // -REQUEST_METHOD
                                        // -REQUEST_URI

    // var_dump($_POST['student']); //jon

    $database = new PDO('mysql:host=devkinsta_db;dbname=Classroom_Management','root','RgLE85FK77jXssOn');
